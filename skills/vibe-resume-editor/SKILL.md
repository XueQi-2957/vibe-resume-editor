...
- The avatar at `assets/avatar-placeholder.svg` is a neutral SVG placeholder and should be replaced by the user when making a real resume.
...
- Project examples should stay generic in public template mode, using placeholder links such as `github.com/example/...`.
